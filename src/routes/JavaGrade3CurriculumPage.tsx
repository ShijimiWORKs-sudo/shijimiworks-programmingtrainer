...
interface JavaCurriculumViewProps {
  course: Course;
  lessonPath: (lessonId: string) => string;
}

export function JavaCurriculumView({ course, lessonPath }: JavaCurriculumViewProps) {
  ...
  return (
    <section className="page-panel">
      ...
      <div className="completion-actions">
        <Link className="secondary-action inline-action" to={routePaths.java}>
          Level Selectへ戻る
        </Link>
      </div>
    </section>
...
export function JavaGrade3CurriculumPage() {
  return <JavaCurriculumView course={javaGrade3Course} lessonPath={routePaths.javaGrade3Lesson} />;
}
