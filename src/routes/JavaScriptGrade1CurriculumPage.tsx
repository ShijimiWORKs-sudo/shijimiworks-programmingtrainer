...
export function JavaScriptGrade1CurriculumPage() {
  ...
  return (
    <section className="page-panel">
      <PageHeader title={javascriptGrade1Course.title} eyebrow="SCR-030">
        <p>{javascriptGrade1Course.description}</p>
      </PageHeader>
      <div className="curriculum-list">
        {javascriptGrade1Course.chapters.map((chapter) => {
          ...
          return (
            <article key={chapter.id} className="chapter-block">
              <div className="chapter-overview">
                ...
                <div className="chapter-progress-summary" aria-label={`${javascriptGrade1Course.title} chapter progress`}>
                ...
                {chapter.lessons.map((lesson) => {
                  ...
                  return (
                    <Link
                      ...
                      to={routePaths.javascriptGrade1Lesson(lesson.id)}
                    >
