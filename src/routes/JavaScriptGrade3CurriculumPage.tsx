...
export function JavaScriptGrade3CurriculumPage() {
  ...
  return (
    <section className="page-panel">
      <PageHeader title={javascriptGrade3Course.title} eyebrow="SCR-030">
        <p>{javascriptGrade3Course.description}</p>
      </PageHeader>
      <div className="curriculum-list">
        {javascriptGrade3Course.chapters.map((chapter) => {
          ...
          return (
            <article key={chapter.id} className="chapter-block">
              <div className="chapter-overview">
                ...
                <div className="chapter-progress-summary" aria-label={`${javascriptGrade3Course.title} chapter progress`}>
                ...
                {chapter.lessons.map((lesson) => {
                  ...
                  return (
                    <Link
                      ...
                      to={routePaths.javascriptGrade3Lesson(lesson.id)}
                    >
