...
export function JavaScriptGrade2CurriculumPage() {
  ...
  return (
    <section className="page-panel">
      <PageHeader title={javascriptGrade2Course.title} eyebrow="SCR-030">
        <p>{javascriptGrade2Course.description}</p>
      </PageHeader>
      <div className="curriculum-list">
        {javascriptGrade2Course.chapters.map((chapter) => {
          ...
          return (
            <article key={chapter.id} className="chapter-block">
              <div className="chapter-overview">
                ...
                <div className="chapter-progress-summary" aria-label={`${javascriptGrade2Course.title} chapter progress`}>
                ...
                {chapter.lessons.map((lesson) => {
                  ...
                  return (
                    <Link
                      ...
                      to={routePaths.javascriptGrade2Lesson(lesson.id)}
                    >
      ...
      <div className="completion-actions">
        <Link className="secondary-action inline-action" to={routePaths.javascript}>
          Level Selectへ戻る
        </Link>
      </div>
    </section>
