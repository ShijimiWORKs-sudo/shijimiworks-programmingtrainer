...
interface CppCurriculumViewProps {
  course: Course;
  lessonPath: (lessonId: string) => string;
}

export function CppCurriculumView({ course, lessonPath }: CppCurriculumViewProps) {
  ...
  return (
    <section className="page-panel">
      ...
      <div className="completion-actions">
        <Link className="secondary-action inline-action" to={routePaths.cpp}>
          Level Selectへ戻る
        </Link>
      </div>
    </section>
...
export function CppGrade3CurriculumPage() {
  return <CppCurriculumView course={cppGrade3Course} lessonPath={routePaths.cppGrade3Lesson} />;
}
