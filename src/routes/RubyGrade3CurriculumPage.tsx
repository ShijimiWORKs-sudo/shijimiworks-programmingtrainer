...
interface RubyCurriculumViewProps {
  course: Course;
  lessonPath: (lessonId: string) => string;
}

export function RubyCurriculumView({ course, lessonPath }: RubyCurriculumViewProps) {
  ...
  return (
    <section className="page-panel">
      ...
      <div className="completion-actions">
        <Link className="secondary-action inline-action" to={routePaths.ruby}>
          Level Selectへ戻る
        </Link>
      </div>
    </section>
...
export function RubyGrade3CurriculumPage() {
  return <RubyCurriculumView course={rubyGrade3Course} lessonPath={routePaths.rubyGrade3Lesson} />;
}
